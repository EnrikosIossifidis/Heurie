...
def visVillage(env, model):
    ...
    tableau20 = [(31, 119, 180), (255, 127, 14), (255, 187, 120),    
             ...
             (44, 160, 44), (188, 189, 34),(174, 199, 232), (219, 219, 141), (23, 190, 207), (24,24,24)]  
    ...
    plt.xticks(fontsize=8, color=tableau20[1])  
    plt.yticks(fontsize=8, color=tableau20[1])   

    # Make the title 
    plt.title("Visual: cables between houses and batteries", fontsize=14, color=tableau20[1])  
